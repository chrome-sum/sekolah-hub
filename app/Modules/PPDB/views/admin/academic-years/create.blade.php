                ...
                <form action="{{ route('admin.ppdb.academic-years.store') }}" method="POST">
                    ...
                    <div class="space-y-4">
                        <div class="form-control w-full">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: Tahun Ajaran 2026/2027" class="input input-bordered w-full @error('name') input-error @enderror" required />
                            @error('name')
                        ...
                        <div class="form-control w-full">
                            ...
                            <input type="text" name="code" value="{{ old('code') }}" placeholder="Contoh: 2026/2027" class="input input-bordered w-full @error('code') input-error @enderror" required />
                            @error('code')
                                <span class="text-rose-600 text-xs mt-1">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-control w-full">
                            ...
                            <input type="datetime-local" name="registration_open_at" value="{{ old('registration_open_at') }}" class="input input-bordered w-full @error('registration_open_at') input-error @enderror" required />
                        ...
                        <div class="form-control w-full">
                            ...
                            <input type="datetime-local" name="registration_close_at" value="{{ old('registration_close_at') }}" class="input input-bordered w-full @error('registration_close_at') input-error @enderror" required />
                        ...
                        <div class="form-control w-full">
                            ...
                            <input type="datetime-local" name="announcement_at" value="{{ old('announcement_at') }}" class="input input-bordered w-full @error('announcement_at') input-error @enderror" required />
                        ...
                        <div class="form-control mt-4">
                            <label class="label cursor-pointer justify-start gap-3">
                                ...
                                <span class="label-text font-medium text-gray-700 text-sm">Jadikan Tahun Ajaran Aktif (Otomatis menonaktifkan tahun ajaran aktif lainnya)</span>
                            </label>
                        </div>
                    </div>
